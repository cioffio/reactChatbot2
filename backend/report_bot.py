...
Column 1 name = Data_point_name. Column 1 entries = [Full legal name, Legal form, Registered address, Principal business address (may be the same as registered address), Business description (SIC codes), Name of key executives, Registration authority, Registration number, Registration date, Registration status, Regulator (only for finanial institutions), Identification of UBO (Ultimate Beneficial Owner), Source of Funds] 
